...
class ResponsablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create responsable" do
    assert_difference('Responsable.count') do
      post responsables_url, params: { responsable: { date: @responsable.date, observation: @responsable.observation } }
    end
  ...
  test "should update responsable" do
    patch responsable_url(@responsable), params: { responsable: { date: @responsable.date, observation: @responsable.observation } }
